...
const Committee: NextPage = () => {
  ...
  */
    ...
    const handleValidDatesRequest = (
        data: { dates: ValidDates } | undefined
    ) => {
        if (!data) {
            return <p>Error</p>;
        } else {
        ...
        <div style={{ marginBottom: "50px" }}>
            ...
            <div>
                <p className="text-center text-lg mt-5 mb-6">
                    Velg ledige tider ved å trykke på eller dra over flere
                    celler.
                    <br></br>Intervjuene vil bli satt opp etter hverandre fra
                    første ledige tid.
                </p>
            </div>
            <form
