    ...
    <div className="w-full max-w-xs mx-auto my-6">
      <div className="relative">
        <input
          ...
          className="block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm disabled:bg-white disabled:cursor-not-allowed disabled:text-gray-500 placeholder:text-sm dark:bg-online-darkBlue"
        />
        <label
