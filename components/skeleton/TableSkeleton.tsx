                ...
                >
                  {columns.map((column) => (
                    <td
                      ...
                      className={`${
                        column.label === "Delete" ? "w-" : "px-4 sm:px-6"
                      } py-2 text-xs sm:py-4 sm:text-sm`}
                    >
                      <div
                        className={`h-5 ${
                          column.label === "Delete" ? "w-8" : "w-36"
                        } bg-gray-200 rounded-full dark:bg-gray-700 shadow animate-pulse`}
                      ></div>
                    </td>
                  ))}
                </tr>
